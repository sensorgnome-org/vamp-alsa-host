...
class Pollable {
  ...
  virtual void handleInput (struct pollfd *pollfds, bool timedOut, double timeNow, PollableMinder *minder) = 0; // handle possible event(s) on the fds for this Pollable
};
